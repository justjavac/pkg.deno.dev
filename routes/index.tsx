...
export default function Home() {
  return (
    <>
      <Head>
        <title>Deno PKG | Deno</title>
      </Head>
      <div class={tw`p-4 mx-auto max-w-screen-md`}>
        <header
          class={tw`relative section-x-inset-sm pt-10 pb-20 flex flex-col items-center`}
        >
          <h1
          ...
          <h2
            class={tw`mt-6 sm:mt-8 font-light text-2xl text-center leading-tight text-gray-900`}
          >
            A <strong class={tw`font-semibold`}>version semantic</strong> and{" "}
            <strong class={tw`font-semibold`}>fast</strong> package delivery
            network for Deno.
          </h2>
        </header>
        ...
        <p class={tw`py-2 mt-4`}>
          Using a <strong class={tw`font-semibold`}>semver range</strong>{" "}
          version:
        </p>
        <ul class={tw`ml-8 list-disc`}>
          <li>
